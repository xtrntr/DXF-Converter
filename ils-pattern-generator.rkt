...
(define (struct-to-format a-struct)
  (match a-struct
    ...
    [(arc highlighted selected visible layer center radius start end p1 p2 p3 ccw) (ils-arc (node-x p1) (node-y p1) (node-x p2) (node-y p2) (node-x p3) (node-y p3))]
